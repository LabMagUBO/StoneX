...
ax.contourf(x_grid, y_grid, f(x_grid, y_grid), 18, alpha=.75, cmap=pl.cm.hot)
C = ax.contour(x_grid, y_grid, f(x_grid, y_grid), 18, colors='black', linewidth=.5)
...
# Points de départ
points_depart = np.array([[-1.5,-0.5], [-1.5,0], [1,0], [1,0.5], [1.5,0]])
